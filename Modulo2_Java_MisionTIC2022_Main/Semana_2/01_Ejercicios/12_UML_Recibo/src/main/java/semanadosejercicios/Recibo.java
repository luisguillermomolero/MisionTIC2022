...
public class Recibo extends Comprobante {
    ...
    public void Mostrar() {
        ...
        System.out.println("Proveedor código");
        System.out.println("Servicio Detalle:" + getDetalle() + ".  \nImporte total: " + getTotal());
    }
}

/**
 * Salida deseada Tipo : R Número: 1 Fecha: 27/10/2011 Proveedor Código: 2023,
 * Razón Social: DeNada. S.A. Servicio Detalle: Pago servicios mensajeria.
 * Total: 5000
 */
